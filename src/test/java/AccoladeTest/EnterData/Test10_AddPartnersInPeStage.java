...
public class Test10_AddPartnersInPeStage extends AccoladeScenario {
    ...
    public void partnersShouldBeAdded() {
        ...
        try {
            ...
            } while (!partnersAccoladePage.numberOfTableRows(4).equals("12"));
        ...
        assertTrue(numberOfPartnersRow == 12);
